    ...
    <div class="container mx-auto">
        ...
        <div class="max-w-lg mx-auto bg-white shadow-lg p-6 rounded-lg">
            <div class="info-box bg-gray-100 p-4 rounded mb-6">
                ...
                <p><strong>Batch:</strong> {{ \Carbon\Carbon::parse($batch->tanggal_mulai)->translatedFormat('d F Y') }} - {{ \Carbon\Carbon::parse($batch->tanggal_selesai)->translatedFormat('d F Y') }}</p>
