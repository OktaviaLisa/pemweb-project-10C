...
@section('content')
<div id="dashboardContent" class="pt-24 min-h-screen flex flex-col justify-between bg-slate-100">
    ...
    <!-- Bagian grafik + tabel biar bisa diexport -->
    <div id="exportArea">
        <!-- Grafik Bootcamp -->
        ...
        <section>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md max-w-5xl mx-auto mb-2 h-96">
                <canvas id="bootcampChart" class="w-full h-full"></canvas>
            </div>

            <div class="mt-7 max-w-5xl mx-auto mb-12 overflow-x-auto">
                    <h3 class="text-xl text-center font-semibold text-primary mb-4">Keterangan Jumlah Pendaftar Bootcamp:</h3>
                    <table class="table-auto w-full border-collapse border border-gray-500 rounded-lg bg-white overflow-hidden">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100 text-center">
                                <td class="py-2 px-4 border border-gray-300 font-semibold">{{ $label }}</td>
                                <td class="py-2 px-4 border border-gray-300">{{ $dataBootcamp[$index] }} pendaftar</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
        ...
        <section>
            ...
            <div class="mt-7 max-w-5xl mx-auto mb-12 overflow-x-auto">
                    <h3 class="text-xl text-center font-semibold text-primary mb-4">Keterangan Jumlah Pendaftar Private Mentoring:</h3>
                    <table class="table-auto w-full border-collapse border border-gray-500 rounded-lg bg-white overflow-hidden">
                        <thead class="bg-secondary text-white">
                            <tr>
                                <th class="py-2 px-4 border border-gray-300">Nama Private Mentoring</th>
                                <th class="py-2 px-4 border border-gray-300">Jumlah Pendaftar</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100 text-center">
                                <td class="py-2 px-4 border border-gray-300 font-semibold">{{ $label }}</td>
                                <td class="py-2 px-4 border border-gray-300">{{ $dataMentoring[$index] }} pendaftar</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    <!-- Footer -->
    <div class="text-center text-gray-600 text-sm pb-10">
        © 2025 UMKMGrow. All rights reserved.
    </div>
</div>
@endsection
