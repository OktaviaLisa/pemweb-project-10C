...
class KelasKeranjangController extends Controller
{
    public function index()
    {
        ...
        // Data chart: hitung jumlah kelas yang ada di keranjang user
...
// Simpan data dari form daftar ke session, lalu redirect ke prosesbayar
    ...
    public function bayar(Request $request)
    {
        ...
        // TODO: proses pembayaran, simpan ke DB, dll

        // Contoh redirect ke halaman sukses (buat route dan view-nya juga)
    ...
    public function terdaftar()
{
    ...
    // Ambil data keranjang beserta relasinya
    $kelas_data = KelasKeranjang::with(['kelas', 'batch'])
        ->where('email', $email)
        ->get();
