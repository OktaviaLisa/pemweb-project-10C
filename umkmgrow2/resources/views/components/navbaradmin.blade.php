            ...
            <div class="flex items-center px-4 space-x-4">
                ...
                <nav id="nav-menu" class="hidden absolute font-semibold py-5 bg-white shadow-lg rounded-lg w-48 left-1/2 -translate-x-1/2 top-16 lg:block lg:static lg:bg-transparent lg:shadow-none lg:w-auto">
                    <ul class="text-center lg:flex lg:space-x-6 ml-10">
                        ...
                        <li class="group"><a href="{{ url('/bootcampadmin') }}" class="py-2 flex text-secondary lg:text-white group-hover:text-primary">Bootcamp</a></li>
                        <li class="group"><a href="{{ url('/mentoringadmin') }}" class="py-2 flex text-secondary lg:text-white group-hover:text-primary">Mentoring</a></li>
                        <li class="group"><a href="{{ url('/eventadmin') }}" class="py-2 flex text-secondary lg:text-white group-hover:text-primary">Event</a></li>
                        <li class="group"><a href="{{ url('/pesertaadmin') }}" class="py-2 flex text-secondary lg:text-white group-hover:text-primary">Peserta</a></li>
                    </ul>
                </nav>
