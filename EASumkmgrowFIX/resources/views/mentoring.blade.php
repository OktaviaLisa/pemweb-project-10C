...
<div class="pt-36 bg-slate-100 min-h-screen pb-20"> {{-- disamakan dengan bootcamp --}}
    <h2 class="mb-10 text-2xl font-bold text-center text-primary">Daftar Mentoring & Batch</h2>

    <div class="p-4 overflow-x-auto"> {{-- disamakan --}}
        <!-- Tombol Tambah Kelas -->
        <div class="mb-4 text-right">
            <a href="{{ url('tambahkelas?jenis=Private Mentoring') }}" 
