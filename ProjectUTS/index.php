    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="flex flex-col items-center text-center bg-white shadow-lg rounded-2xl p-6 max-w-sm mx-auto">
                ...
                <a href="kelas.php" class="mt-3 inline-block text-sm font-semibold text-white bg-primary py-2 px-6 rounded-lg hover:shadow-lg hover:opacity-80 transition duration-300">
                    Lihat Selengkapnya
                </a>
            </div>
            ...
            <div class="flex flex-col items-center text-center bg-white shadow-lg rounded-2xl p-6 max-w-sm mx-auto">
                ...
                <a href="#" class="mt-3 inline-block text-sm font-semibold text-white bg-primary py-2 px-6 rounded-lg hover:shadow-lg hover:opacity-80 transition duration-300">
                    Lihat Selengkapnya
                </a>
            </div>
